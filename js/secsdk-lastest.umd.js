...
(function (global, factory) {
  ...
  var global_1 =
    ...
    check(
      (typeof globalThis === "undefined"
        ? "undefined"
        : _typeof$1(globalThis)) == "object" && globalThis,
    ) ||
    check(
    ...
    check(
      (typeof self === "undefined" ? "undefined" : _typeof$1(self)) ==
        "object" && self,
    ) ||
    check(_typeof$1(commonjsGlobal) == "object" && commonjsGlobal) ||
    check(_typeof$1(commonjsGlobal) == "object" && commonjsGlobal) ||
  ...
  var requireObjectCoercible = function requireObjectCoercible(it) {
    if (isNullOrUndefined(it))
      throw new $TypeError$c("Can't call method on " + it);
    return it;
  };
  ...
  var wellKnownSymbol = function wellKnownSymbol(name) {
    if (!hasOwnProperty_1(WellKnownSymbolsStore, name)) {
      WellKnownSymbolsStore[name] =
        symbolConstructorDetection && hasOwnProperty_1(_Symbol, name)
          ? _Symbol[name]
  ...
  var f$4 = descriptors
    ...
    : function defineProperty(O, P, Attributes) {
        ...
        if ("get" in Attributes || "set" in Attributes)
          throw new $TypeError$7("Accessors not supported");
  ...
  var functionUncurryThisAccessor = function functionUncurryThisAccessor(
    object,
    key,
    method,
  ) {
  ...
  var errorStackClear = function errorStackClear(stack, dropEntries) {
    if (
      ...
      while (dropEntries--)
        stack = replace$3(stack, V8_OR_CHAKRA_STACK_ENTRY, "");
    }
    return stack;
  };
  ...
  var errorStackInstall = function errorStackInstall(
    error,
    C,
    stack,
    dropEntries,
  ...
  var isArrayIteratorMethod = function isArrayIteratorMethod(it) {
    return (
      it !== undefined &&
      (iterators.Array === it || ArrayPrototype$1[ITERATOR$7] === it)
    );
  };
  ...
  var iterate = function iterate(iterable, unboundFunction, options) {
    ...
    if (IS_RECORD) {
      ...
      if (!iterFn)
        throw new $TypeError$4(tryToString(iterable) + " is not iterable");
  ...
  var normalizeStringArgument = function normalizeStringArgument(
    argument,
    $default,
  ) {
  ...
  var defineBuiltInAccessor = function defineBuiltInAccessor(
    target,
    name,
    descriptor,
  ) {
  ...
  var speciesConstructor = function speciesConstructor(O, defaultConstructor) {
    ...
    var S;
    return C === undefined || isNullOrUndefined((S = anObject(C)[SPECIES$3]))
      ? defaultConstructor
      : aConstructor(S);
  };
  ...
  var functionApply =
    ((typeof Reflect === "undefined" ? "undefined" : _typeof$1(Reflect)) ==
      "object" &&
      Reflect.apply) ||
    (functionBindNative
      ? call.bind(apply)
  ...
  var validateArgumentsLength = function validateArgumentsLength(
    passed,
    required,
  ) {
  ...
  var engineIsIosPebble =
    /ipad|iphone|ipod/i.test(engineUserAgent) && typeof Pebble != "undefined";
  ...
  var engineIsDeno =
    (typeof Deno === "undefined" ? "undefined" : _typeof$1(Deno)) == "object" &&
    Deno &&
    _typeof$1(Deno.version) == "object";
  ...
  var internalResolve = function internalResolve(state, value, unwrap) {
    ...
    try {
      if (state.facade === value)
        throw new TypeError$3("Promise can't be resolved itself");
  ...
  var arraySpeciesConstructor = function arraySpeciesConstructor(
    originalArray,
  ) {
    var C;
  ...
  var arrayMethodIsStrict = function arrayMethodIsStrict(
    METHOD_NAME,
    argument,
  ) {
  ...
  var URLSearchParamsIterator = iteratorCreateConstructor(
  ...
  defineBuiltIn(
    URLSearchParamsPrototype$3,
    ITERATOR,
    URLSearchParamsPrototype$3.entries,
    {
      name: "entries",
    },
  );
  ...
  var percentEncode = function percentEncode(chr, set) {
    ...
    return code > 0x20 && code < 0x7f && !hasOwnProperty_1(set, chr)
      ? chr
  ...
  if (NativeURL) {
    ...
    if (nativeCreateObjectURL)
      defineBuiltIn(
        URLConstructor,
        "createObjectURL",
        functionBindContext(nativeCreateObjectURL, NativeURL),
      );
    ...
    if (nativeRevokeObjectURL)
      defineBuiltIn(
        URLConstructor,
        "revokeObjectURL",
        functionBindContext(nativeRevokeObjectURL, NativeURL),
      );
  }
  ...
  var createClass = createCommonjsModule(function (module) {
    function _defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        ...
        Object.defineProperty(
          target,
          toPropertyKey_1(descriptor.key),
          descriptor,
        );
      }
    }
    ...
    _createClass(CSRFDefenser, [
      {
        ...
        value: function setProtectedHost() {
          ...
          if (typeof host === "string") {
            this.protectionConfig[host] = Object.assign(
              {},
              DEFAULT_HOST_PROTECTION_CONFIG,
            );
          } else if (Array.isArray(host)) {
            host.forEach(function (h) {
              _this.protectionConfig[h] = Object.assign(
                {},
                DEFAULT_HOST_PROTECTION_CONFIG,
              );
            });
          } else if (
            Object.prototype.toString.call(host) === "[object Object]"
          ) {
            Object.keys(host).forEach(function (h) {
              ...
              if (
                Object.prototype.toString.call(hostProtectionConfig) ===
                "[object Object]"
              ) {
                Object.keys(hostProtectionConfig).forEach(function (m) {
                  _this.protectionConfig[h][m.toUpperCase()] =
                    hostProtectionConfig[m];
                });
              }
            });
          }
      ...
      },
      {
        ...
        value: function setAllowedHost(host) {
          ...
          Object.keys(host).forEach(function (h) {
            ...
            var hostProtectionConfig = host[h];
            Object.keys(hostProtectionConfig).forEach(function (m) {
              _this2.whiteListConfig[h][m.toUpperCase()] =
                hostProtectionConfig[m];
            });
          });
        },
        ...
        value: function setOptions() {
          ...
          if (isGlueOptions) {
            var _options$protect = options.protect,
              ...
              downgradeLimit =
                _options$downgradeLim === void 0 ? -1 : _options$downgradeLim,
              _options$downgradeMax = options.downgradeMaxAge,
              downgradeMaxAge =
                _options$downgradeMax === void 0 ? 1000 : _options$downgradeMax,
              _options$tokenFetchTi = options.tokenFetchTimeout,
              tokenFetchTimeout =
                _options$tokenFetchTi === void 0
                  ? 10000
                  : _options$tokenFetchTi;
      ...
      },
      {
        ...
        value: function fetchToken() {
          ...
          if (!this.tokenMap[host]) {
            this.tokenMap[host] = this.fetchTokenFromServer(
              host,
              this.getTokenPath(host, pathname),
            ).then(function (token) {
          ...
          return Promise.resolve(this.tokenMap[host]).then(function (token) {
            if (token.expiredAt < Date.now()) {
              ...
              if (
                (_this3.downgradeLimit === -1 && !token.timeout) ||
                !_this3.checkDowngradeLimit(host)
              ) {
      ...
      },
      {
        ...
        value: function getCrossSiteSessionMapFromStorage() {
          return JSON.parse(
            window.localStorage.getItem(this.secsdkSessionName) || "{}",
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function fetchTokenFromServer(host, pathname) {
          ...
          return new Promise(function (resolve) {
            ...
            var protocol = ["http:", "https:"].includes(
              ...
              console.error(
                new Error(
                  "Failed to fetch csrf token: host="
                    .concat(host, " downgradeLimit: ")
                    .concat(_this4.downgradeLimit),
                ),
              );
            ...
            xhr.addEventListener("load", function () {
              ...
              if (csrfHeaderValue) {
                ...
                console.warn(
                  "Failed to get csrf token: host="
                    .concat(host, " xWareCsrfToken=")
                    .concat(csrfHeaderValue),
                );
                resolve(downgradeToken);
                _this4.incrementDowngradeLimitCount(host);
                return;
              ...
              if (!(tokenInfo[0] === "0")) {
                console.warn(
                  "Failed to fetch csrf token: host="
                    .concat(host, " status_code=")
                    .concat(tokenInfo[0], " message=")
                    .concat(tokenInfo[3]),
                );
                resolve(downgradeToken);
                _this4.incrementDowngradeLimitCount(host);
              ...
              if (
                ...
                window.localStorage.setItem(
                  defenser.secsdkSessionName,
                  JSON.stringify(
                    Object.assign(
                      Object.assign({}, sessionMap),
                      _defineProperty({}, host, tokenInfo[4]),
                    ),
                  ),
                );
              }
              var maxAge =
                parseInt(tokenInfo[2], 10) || DEFAULT_NORMAL_TOKEN_MAX_AGE;
              resolve({
                value: tokenInfo[1],
            ...
            _this4.nativeXMLHttpRequestOpen.call(
              xhr,
              "HEAD",
              "".concat(protocol, "//").concat(host).concat(pathname),
            );
            var sessionId = defenser.defaultSessionVal;
            _this4.nativeXMLHttpRequestSetRequestHeader.call(
              xhr,
            ...
            _this4.nativeXMLHttpRequestSetRequestHeader.call(
              xhr,
              _this4.secsdkVersionHeaderName,
              _this4.secsdkVersion,
            );
        ...
        value: function monkeyPatchXMLHttpRequest() {
          ...
          XMLHttpRequest.prototype.send = function () {
            ...
            if (openArgs.length >= 3 && !openArgs[2]) {
              ...
              if (
                defenser.isCrossSite(
                  "".concat(u.protocol, "//").concat(u.host).concat(u.pathname),
                )
              ) {
                var sessionId =
                  defenser.getCrossSiteSessionMapFromStorage()[u.host];
                //跨站请求，sessionId以 req header传送
                sessionId && (token = "".concat(token, ",").concat(sessionId));
              }
              defenser.nativeXMLHttpRequestSetRequestHeader.call(
                this,
                defenser.tokenHeaderName,
                token,
              );
              return defenser.nativeXMLHttpRequestSend.apply(this, sendArgs);
            }
            ...
            defenser.fetchToken(u.host, u.pathname).then(function (token) {
              ...
              if (
                ...
                //跨站请求，sessionId以 req header传送
                _sessionId &&
                  (tokenVal = "".concat(tokenVal, ",").concat(_sessionId));
              }
              defenser.nativeXMLHttpRequestSetRequestHeader.call(
                _this5,
                defenser.tokenHeaderName,
            ...
            return defenser
              ...
              .then(function (token) {
                ...
                if (
                  ...
                  //跨站请求，sessionId以 req header传送
                  sessionId &&
                    (tokenVal = "".concat(tokenVal, ",").concat(sessionId));
                }
                if (IS_REQUEST_API_SUPPORTED && input instanceof Request) {

!(function () {
  ...
  function p(n, t, e) {
    for (
      var r, o = (t = C(t.split(".")))[0], i = t.slice(1);
      n && 0 < i.length;
    )
      ((n = n[o]), (o = (r = C(i))[0]), (i = r.slice(1)));
    if (n) return e(n, o);
  }
  function c(n) {
      ...
      m = {
        ...
        set: function (n) {
          l &&
            n &&
            w(n) &&
            (y("beforeConfig", !1, n), null != r && r.setConfig(n));
        },
        config: function (n) {
          if (l)
            return (
              n &&
                w(n) &&
                (y("beforeConfig", !1, n), null != r && r.setConfig(a(n))),
            ...
            (d ||
              (null != r &&
                r.onReady(function () {
                  var t, n;
                  (y("start", (d = !0)),
                    (n = (t = m).getPreStartQueue()).forEach(function (n) {
                      return t.build(n);
                    }),
                    (n.length = 0));
                })));
              ...
              ((t = I(s.report)(e)) &&
                (d
                  ...
                  : ((n = m),
                    ...
                    e.length < 500 ||
                      ((e = e.splice(0, 50)),
                      n.savePreStartDataToDb && n.savePreStartDataToDb(e))))));
        },
        build: function (n) {
          !d ||
            ((n = I(s.beforeBuild)(n)) &&
              (!(n = t.build(n)) || ((n = I(s.build)(n)) && this.send(n))));
        },
        send: function (n) {
  ...
  var Y = function (n) {
      try {
        "object" == typeof window &&
          ...
          window.__SLARDAR_DEVTOOLS_GLOBAL_HOOK__.push(n);
      } catch (n) {}
    },
    $ = function () {
      return Date.now();
  ...
  function Q() {
    if ("object" == typeof window && w(window)) return window;
  }
  function Z() {
    if ("object" == typeof document && w(document)) return document;
  }
  function nn() {
    return Q() && window.location;
  }
  function tn() {
    var n = (function () {
      if (Q() && "navigator" in window) return window.navigator;
    })();
  ...
  function cn(n) {
    var t = n.config();
    return (
      ((t = { pid: t.pid, view_id: t.viewId, url: an() }).context = n.context
        ? n.context.toString()
        : {}),
      t
    );
  ...
  var sn = function (t, n) {
    ...
    vn = function (n) {
      var t = { url: an(), timestamp: $() },
        e = n.config();
      return (
        null != e && e.pid && (t.pid = e.pid),
  ...
  var Rn = function (n) {
      try {
        var t = localStorage.getItem(n),
          ...
          r = (e =
            t && "string" == typeof t
              ? JSON.parse(((u = t), bn() ? decodeURI(atob(u)) : u))
              : e),
          o = r.expires,
          i = (function (n, t) {
            var e = {};
            ...
            if (null != n && "function" == typeof Object.getOwnPropertySymbols)
              for (
                var r = 0, o = Object.getOwnPropertySymbols(n);
                r < o.length;
                r++
              )
                t.indexOf(o[r]) < 0 &&
      ...
      if (!(e <= 0))
        try {
          localStorage.setItem(
            n,
            ((r = JSON.stringify(y(y({}, t), { expires: $() + e }))),
            bn() ? btoa(encodeURI(r)) : r),
          );
        } catch (n) {}
    },
    jn = function (n) {
  ...
  function Dn(n, t) {
    return !n || !t || Fn.test(n) || Yn.test(t);
  }
  function Ln(n, t) {
    try {
      if (t) {
        ...
        if (!r) return;
        ((n.request.url = r),
          (n.extra = y(y({}, n.extra), { original_url: e })));
      }
    } catch (n) {}
  }
  var qn = "xhr_0",
    Pn = function (r) {
      return function (n, t) {
        ...
        r &&
          ((e = []).push(s(r, "open", An)()),
          e.push(s(r, "setRequestHeader", Tn)()),
          e.push(s(r, "send", Cn)(n)),
          t(function () {
    ...
    Un = [
      ...
      function (t, n) {
        var e,
          r = (function () {
            if (Q() && l(window.PerformanceObserver))
    ...
    Vn = function (n) {
      ...
      if (r && T(r.sampleRate))
        return function (n, t) {
          ...
          e.length &&
            O(e, n) &&
            t("traceparent", "03-" + kn() + "-" + kn().substring(16) + "-01");
        };
    },
    Fn = new RegExp(
    ...
    Yn = new RegExp("(bearer|session)", "i"),
    $n = function (n, t, c) {
      var e = C(t, 2),
        t = e[0],
        f = e[1],
          ...
          return function (n) {
            ...
            var t = (function (n, t) {
              ...
              if (typeof n.getAllResponseHeaders === "function")
                c.response.headers = Qn(n.getAllResponseHeaders());
              var f = c.response.status,
                s = t.collectBodyOnError,
                l = t.extraExtractor;
              try {
                var d =
                  l === null || l === void 0 ? void 0 : l(n.response, c, u);
                d && (c.extra = d);
            ...
            setTimeout(function () {
              (u && (t.response.timing = u),
                Ln(t, p),
                i && i({ ev_type: Jn, payload: t }),
                a());
            }, 100);
          };
        }),
  ...
  function Zn(e) {
    return Object.keys(e).reduce(function (n, t) {
      return (Dn(t, e[t]) || (n[t.toLowerCase()] = e[t]), n);
    }, {});
  }
  var nt = "ajax",
    tt = {
  ...
  var et = function (n, t, d) {
          ...
          t[0](function (n) {
            ...
            o &&
              o(t, function (n, t) {
                return (function (n, t, e, r, o, i) {
                  var u;
                  if (rt(e, o)) e.headers.set(n, t);
                  else if (r.headers instanceof i) r.headers.set(n, t);
                  else
                    r.headers = y(y({}, r.headers), ((u = {}), (u[n] = t), u));
                })(n, t, u, a, m, g);
              });
            var c = v(),
              f = $(),
            ...
            return function (n) {
              ...
              var t,
                ...
                r = (function (r, o, n, i, t, e, u) {
                  var a = {
                      ...
                      request: {
                        method: ot(r, o, i),
                        timestamp: u,
                        url: on(r instanceof i ? r.url : r),
                        headers: it(t, r.headers, o.headers),
                      },
                      response: {
                        status: (n && n.status) || 0,
                        is_custom_error: false,
                    ...
                    s = function () {
                      ...
                      c &&
                        (a.request.body =
                          (n = ut(r, o, i)) === null || n === void 0
                            ? void 0
                            : n.toString());
                    };
                  if (n)
                    try {
                      var l = it(t, n.headers);
                      a.response.headers = l;
                      try {
                        (l["content-type"] || "").indexOf(
                          "application/json",
                        ) !== -1 &&
                          f &&
                          n
                ...
                o =
                  ((e = !(t = function (n) {
                    (s && (n.response.timing = s),
                      Ln(n, h),
                      c && c({ ev_type: Jn, payload: n }),
                      l());
                  })),
                  function (n) {
                    e || ((e = !0), t(n));
    ...
    ot = function (n, t, e) {
      t = (t && t.method) || "get";
      return (t = rt(n, e) ? n.method || t : t).toLowerCase();
    },
    it = function (t) {
    ...
    ut = function (n, t, e) {
      return rt(n, e) ? n.body : null == t ? void 0 : t.body;
    },
    at = "fetch",
    ct = {
      autoWrap: !0,
  ...
  function dt(e) {
    return function (n, t) {
      e({ ev_type: zn, payload: { pid: t, source: n } });
    };
  }
  function pt(n, t) {
    var e = n[0] + n[1] + n[2],
      r = n[0] / e;
    return n[2] / e > t.frustrating_threshold
      ? 2
      : r > t.satisfying_threshold || 0 === e
        ? 0
        : 1;
  }
  function vt(o, i) {
    return function (n, t) {
      ...
      switch (n.ev_type) {
        case "performance":
          var r = e.name;
          e.isSupport && o(t[Ot], r, e.value);
          break;
        case "action":
          o(t[Ot], "action", e.duration || 0);
          break;
        case Wn:
          i(t[St], 0);
          break;
        case Jn:
          e.response.is_custom_error || 400 <= e.response.status
            ? i(t[St], 1)
            : (r = e.response.timing) && o(t[Rt], 0, r.duration);
          break;
        case "resource_error":
          i(t[St], 2);
          break;
  ...
  var gt = ["name", "message", "stack", "filename", "lineno", "colno"],
    mt = "jsError",
    yt = [
      "hidden_3",
      function (t, n) {
    ...
    It = function (r, t, n, e) {
      ...
      return (
        ...
        [
          function (n, t) {
            if (!l) return ((l = [$(), n, t]), R(n), void (v = !(!p || !l)));
            (v && ((d = T()), E(d, n)), (l = [$(), n, t]), _());
          },
          function (n) {
            v &&
              (s || (A(n, p), "action" === n.ev_type && S()),
              n.common.pid === l[1] && I(n, p));
          },
          function (n) {
  ...
  function Ct(e) {
    function r(n) {
      ...
      t &&
        ((n = jn(r)) && (t.stacks = n),
        e.report({ ev_type: Xn, payload: t, extra: { timestamp: $() } }));
    }
    (e.provide("sendEvent", r),
      e.provide("sendLog", function (n) {
        n = Bt(n);
        n && e.report({ ev_type: Xn, payload: n, extra: { timestamp: $() } });
      }));
  }
  function kt(n, t) {
    var e = n.common || {};
  ...
  var Nt = function (n) {
      if (n && w(n) && n.name && E(n.name)) {
        var t = { name: n.name, type: "event" };
        if ("metrics" in n && w(n.metrics)) {
          var e = n.metrics,
            r = {};
          for (o in e) a(e[o]) && (r[o] = e[o]);
          t.metrics = r;
        }
        if ("categories" in n && w(n.categories)) {
          var o,
            i = n.categories,
            u = {};
    ...
    Bt = function (n) {
      if (n && w(n) && n.content && E(n.content)) {
        var t = { content: f(n.content), type: "log", level: "info" };
        if (("level" in n && (t.level = n.level), "extra" in n && w(n.extra))) {
          var e,
            r = n.extra,
            o = {},
            i = {};
    ...
    Ht = function (n) {
      ...
      (t &&
        ...
        n.on("report", function (n) {
          return y(y({}, n), {
            extra: y(y({}, n.extra || {}), { network_type: e }),
          });
        }));
    },
    Mt = function (n, t, e, r, o) {
      if (!t) return x;
      var i = t.sample_rate,
        u = t.include_users,
      ...
      return function (n) {
        if (!m()) return (g && o[0](), !1);
        if (!(n.ev_type in y)) return kt(n, i);
        ...
        if (e)
          for (var r = 0; r < e.length; r++)
            if (qt(n, e[r].filter))
              return !!e[r].hit() && kt(n, e[r].effectiveSampleRate);
        return t.hit()
          ? kt(n, t.effectiveSampleRate)
          : ((e && e.length) || !g || o[1](n.ev_type), !1);
      };
    };
  function Ut(n) {
    n = new Error(n);
    return ((n.name = "RequestNetworkError"), n);
  }
  function zt(n, t, e) {
    var r = t.url,
      o = t.data,
      i = t.success,
      u = void 0 === i ? b : i,
      a = void 0 === (i = t.fail) ? b : i,
      c = void 0 === (i = t.getResponseText) ? b : i,
    ...
    (((e = new e()).withCredentials = t),
      ...
      (e.onload = function () {
        ...
        try {
          ...
          400 <= this.status
            ? a(
                ((t = this.responseText || this.statusText),
                ((t = new Error(t)).name = "ReqeustServerError"),
                t),
              )
            : this.responseText
      ...
      (e.onerror = function () {
        a(Ut("Network request failed"));
      }),
      (e.onabort = function () {
        a(Ut("Network request aborted"));
      }),
      e.send(o));
  }
  function Gt() {
    ...
    var n,
      ...
      l =
        ...
        (s = 0),
        {
          ...
          send: function (n) {
            (f.push(n),
              f.length >= a && d.call(this),
              clearTimeout(s),
              (s = setTimeout(d.bind(this), c)));
          },
          flush: function () {
    ...
    return (
      yn(function () {
        ...
        e.transport.useBeacon
          ? ((t = Pt()),
            (n = l.getBatchData()) && (t.post(l.getEndpoint(), n), l.clear()),
            (l.send = function (n) {
              t.post(l.getEndpoint(), v([n]));
            }),
            _n(function () {
              l.send = p;
            }))
  ...
  var Jt =
      "https://" +
      (un(
        (null === (Xe = rn()) || void 0 === Xe
          ? void 0
          : Xe.getAttribute("src")) || "",
      ).domain || "sf16-short-sg.bytedapm.com") +
      "/slardar/fe/sdk-web/plugins",
    Xt = "1.16.6",
    Kt = "/monitor_web/settings/browser-settings",
    Vt = "/monitor_browser/collect/batch/",
    Ft = "SLARDAR",
    Yt = ["/log/sentry/", Vt, Kt],
    $t = "session",
    Qt = ["blankScreen", "action"],
    Zt = {
      sample_rate: 1,
      include_users: [],
  ...
  function re(o) {
    return function (n, t) {
      ...
      (o.destroyAgent.has(n) && o.destroyAgent.remove(n),
        void 0 !== t &&
          o.set({
            plugins: y(y({}, o.config().plugins), (((e = {})[n] = t), e)),
          }),
        (r && ~r.plugins.indexOf(n) ? oe : ie)([n], o));
    };
  }
  var oe = function (n, t, e, r) {
      void 0 === r && (r = ae);
      var o = t.config(),
        i = o.plugins,
        o = o.pluginBundle,
  ...
  function ue(n, t, e) {
    ...
    var r = n.config().pluginBundle,
      r = r ? r.plugins : [];
    (oe(r, n, t, e), ie(Qt, n, t, e), n.provide("reloadPlugin", re(n)));
  }
  function ae(n, t, e, r) {
    var o = t.name,
      t = t.config;
  ...
  function fe(n, t) {
    return n.plugins.filter(function (n) {
      return n.name === t && n.version === Xt;
    })[0];
  }
  function se(n, t) {
    return !(!(t = void 0 === t ? pn(Q()) : t) || !t.plugins) && !!fe(t, n);
  }
  function le(n, t, e) {
    (e = void 0 === e ? pn(Q()) : e) &&
      e.plugins &&
      (fe(e, n) || e.plugins.push({ name: n, version: Xt, apply: t }));
  }
  function de(n) {
    var t, e;
    try {
  ...
  function pe(n) {
    var t,
      e = n.plugins || {};
    for (t in e) e[t] && !w(e[t]) && (e[t] = {});
    return de(y(y({}, n), { plugins: e }));
  }
  function ve(n) {
    return w(n) && "bid" in n;
  }
  ...
  function ye(n, t) {
    ...
    return t <= 0
      ...
      : ((function (n, t) {
        ...
        {
          userId: (null == (n = Rn(n)) ? void 0 : n.userId) || e.userId,
    ...
    we = function (t) {
                  ...
                  : (function (e, r, o, i, u) {
                      ...
                      function m(n) {
                        return d
                          ? g(d, !1)
                          : (function (n) {
                                if (c <= p || "RequestNetworkError" !== n.name)
                                  return !1;
                                return S(["slow-2g", "2g"], en(tn()));
                              })(n) && l
                            ? void l.setTimeout(h, f)
                            : ((t = Q()) &&
                                  "navigator" in t &&
        ...
        onReady: function (o) {
          ((a = function () {
            ...
            ((t = (n = i).bid),
              ...
              (r = n.deviceId),
              (n = n.storageExpires),
              On(Ft + t, { userId: e, deviceId: r }, Sn(n)),
              o());
          }),
            r && a());
        },
      ...
      function f() {
        ...
        ((n.plugins = (function () {
          ...
          return e;
        })(t.plugins, (null == r ? void 0 : r.plugins) || {}, o.plugins || {})),
          (n.sample = Ee(
            Ee(t.sample, null == r ? void 0 : r.sample),
            o.sample,
          )),
          (i = n),
          c());
        ...
        ((r = (function (n) {
          ...
          return {
            sample: {
              ...
              sample_granularity: void 0 === a ? $t : a,
            ...
            plugins: {
              heatmap:
                null !== (e = null == e ? void 0 : e.heatmap) &&
                void 0 !== e &&
                e,
            },
            apdex: i,
  ...
  function Ee(r, o) {
    ...
    return (
      (n.include_users = _(
        _([], C(r.include_users || []), !1),
        C(o.include_users || []),
        !1,
      )),
      (n.rules = _(
        _([], C(Object.keys(r.rules || {})), !1),
        C(Object.keys(o.rules || {})),
        !1,
      ).reduce(function (n, t) {
        var e;
        return (
          t in n ||
            (t in (r.rules || {}) && t in (o.rules || {})
              ? ((n[t] = y(y({}, r.rules[t]), o.rules[t])),
                (n[t].conditional_sample_rules = _(
                  _([], C(r.rules[t].conditional_sample_rules || []), !1),
                  C(o.rules[t].conditional_sample_rules || []),
                  !1,
                )))
              : (n[t] =
  ...
  function Se(n) {
    ...
    return {
      ev_type: Wn,
      payload: { error: st(n), breadcrumbs: [], extra: t || {} },
  ...
  function Re(n) {
    var t = (e = void 0 === n ? {} : n).createSender,
      ...
      r = z({
        validateInitConfig: ve,
        initConfigNormalizer: pe,
        userConfigNormalizer: he,
        createSender:
          void 0 === t
            ? function (n) {
                return Wt({
                  size: ne,
                  endpoint: _e(n.domain),
                  transport: n.transport,
                });
              }
            : t,
        builder: void 0 === n ? je : n,
        createDefaultConfig: void 0 === e ? He : e,
        createConfigManager: we,
      });
    (qe(r), G(r));
    var o,
      i,
  ...
  var je = {
      build: function (n) {
        return {
          ev_type: n.ev_type,
          payload: n.payload,
          common: y(y({}, n.extra || {}), n.overrides || {}),
        };
      },
    },
    Ie = function (u) {
      (u.on("report", function (n) {
        ...
        u.on("init", function () {
          ...
          i.forEach(function (n, t) {
            var e = n.extra || {};
            i[t] = y(y({}, n), {
              extra: y(y({}, e), { pid: e.pid || r, view_id: e.view_id || o }),
            });
          });
        }));
    },
    ...
    Le = function (n, t) {
      return "err" === t
        ? !1 !==
            p(n, "plugins." + mt + ".onerror", function (n, t) {
              return n[t];
            })
        : "reject" !== t ||
            !1 !==
              p(n, "plugins." + mt + ".onunhandledrejection", function (n, t) {
                return n[t];
              });
    },
    qe = function (t, n) {
          ...
          ((e = p),
            (l = En((n = d), Tt)) &&
              ...
              i &&
                ((r = []),
                (n = (d = C(
                  It(e.report.bind(e), r, [V(e, yt), V(e, _t)], l),
                  4,
                ))[0]),
                (o = d[1]),
                (i = d[2]),
              ...
              (f = C(
                jt(
                  c,
                  (c = []),
                  Et(t) ? [] : [e.initSubject(bt), e.initSubject(xt)],
                  y(y({}, l), {
                    initPid:
            ...
            (t = En((t = t), tt)) &&
              ...
              o.autoWrap &&
                $n(
                  r,
                  [
                    V(n, [qn, Pn(XMLHttpRequest && XMLHttpRequest.prototype)]),
                    i,
                  ],
                  o,
                ),
  ...
  Je &&
    Xe &&
    ((Ge = (null == (Ge = Je[Xe]) ? void 0 : Ge.q) || []),
    (Je[Xe] = Ue),
    Ge.forEach(function (n) {
      var t, e;
      ((e = n),
        (n = y(y({}, vn((t = Ue))), { url: e.pop(), timestamp: e.pop() })),
        hn(
          t,
          n,
        )(function () {
          t.apply(void 0, _([], C(e), !1));
        }));
    }),
    (Ge.length = 0),
    Ue.p &&
      ...
      (Ue.p.a = ge(Ue.p.a)),
      (We = Ue.precollect) &&
        Ue.provide("precollect", function () {
          for (var n = [], t = 0; t < arguments.length; t++)
            n[t] = arguments[t];
          return (
            Ue.p.a.push(_(["precollect"], C(n), !1)),
            We.apply(void 0, _([], C(n), !1))
          );
        })));
})();
